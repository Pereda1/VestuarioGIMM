...
CREATE TABLE `Productos` (
  ...
  `DISPVEST` int(32) DEFAULT NULL,
  `DISPMAQ` int(32) DEFAULT NULL,
  `DISPLAV` int(32) DEFAULT NULL,
  `DISPALM` int(32) DEFAULT NULL,
  `REQMUERTO` int(32) DEFAULT NULL,
  `CANT` int(32) DEFAULT NULL,
